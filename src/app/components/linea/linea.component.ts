...
export class LineaComponent  {
  ...
  // Datos mockdata que pueden venir de un servicio
  ...
  // Opciones de como mostrarse la gráfica y tabla
  ...
  // Configuración de los colores de las lineas
  ...
  // Crear cambios  aleatorios de las gráficos
  ...
  // Eventos para cambiar la gráfica
